(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/node_modules_dplayer_dist_DPlayer_min_2a158482.js", {
...
!function(e, t) {
    ...
    return function(e) {
        ...
        function(e, t, n) {
            ...
            function u(e, t) {
                if (null !== e && void 0 !== e) if ("object" !== (void 0 === e ? "undefined" : i(e)) && (e = [
                    e
                ]), s(e)) for(var n = 0, a = e.length; n < a; n++)t.call(null, e[n], n, e);
        ...
        function(e, t, n) {
            ...
            var i = b(n(46)), a = b(n(45)), o = b(n(44)), r = b(n(43)), s = b(n(42)), l = b(n(41)), c = b(n(40)), u = b(n(39)), d = b(n(38)), p = b(n(37)), h = b(n(36)), f = b(n(35)), y = b(n(34)), m = b(n(33)), v = b(n(32)), g = b(n(31));
            function b(e) {
        ...
        function(e, t, n) {
            ...
            e.exports = function(e) {
                "use strict";
                var t = "", n = (e = e || {}).enableSubtitle, a = e.subtitle, o = e.current, r = e.pic, s = i.$escape, l = e.screenshot, c = e.preload, u = e.url;
                n = a && "webvtt" === a.type;
        ...
        function(e, t, n) {
            "use strict";
            var i = n(0), a = n(62), o = n(60), r = n(59), s = n(58), l = n(9), c = "undefined" != typeof window && window.btoa && window.btoa.bind(window) || n(57);
            e.exports = function(e) {
                return new Promise(function(t, u) {
                    ...
                    if (h.open(e.method.toUpperCase(), o(e.url, e.params, e.paramsSerializer), !0), h.timeout = e.timeout, h[f] = function() {
                        ...
                        var g = n(56), b = (e.withCredentials || s(e.url)) && e.xsrfCookieName ? g.read(e.xsrfCookieName) : void 0;
        ...
        function(e, t, n) {
            ...
            t.default = function e(t) {
                !function(e, t) {
                    ...
                    if (t.focus) {
                        var n = document.activeElement.tagName.toUpperCase(), i = document.activeElement.getAttribute("contenteditable");
            ...
            var s = function() {
                function e(t) {
                    ...
                    if (this.player.danmaku) {
                        ...
                        var o = function(e) {
                            var t = e || window.event, i = ((t.clientX || t.changedTouches[0].clientX) - r.default.getBoundingClientRectViewLeft(n.player.template.danmakuOpacityBarWrap)) / 130;
            ...
            var l = function() {
                ...
                return i(e, [
                        ...
                        value: function() {
                            ...
                            this.player.template.playedBarWrap.addEventListener(a.default.nameMap.dragStart, function() {
                                ...
                                if (e.player.video.duration) {
                                    var n = a.default.cumulativeOffset(e.player.template.playedBarWrap).left, i = (t.clientX || t.changedTouches[0].clientX) - n;
                    ...
                    },
                    {
                        ...
                        value: function() {
                            var e = this, t = function(t) {
                                var n = t || window.event, i = ((n.clientX || n.changedTouches[0].clientX) - a.default.getBoundingClientRectViewLeft(e.player.template.volumeBarWrap) - 5.5) / 35;
                                e.player.volume(i);
                            }, n = function n() {
            ...
            var s = function() {
                ...
                return a(e, [
                    ...
                    },
                    {
                        key: "request",
                        value: function() {
                            var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "browser", t = "browser" === e ? "web" : "browser", n = this.isFullScreen(t);
        ...
        function(e, t, n) {
            ...
            var a = function() {
                function e() {
                    !function(e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function");
                    }(this, e), this.events = {}, this.videoEvents = [
                        "abort",
                        "canplay",
                        "canplaythrough",
                        "durationchange",
                ...
                return o(e, [
                    ...
                    },
                    {
                        ...
                        value: function(e) {
                            var t = this;
                            if (this.showing) {
                                var n = this.options.height, i = this.container.offsetWidth, o = this.container.offsetHeight, r = parseInt(o / n), l = function(e) {
                                    var n = e.offsetWidth || parseInt(e.style.width), i = e.getBoundingClientRect().right || t.container.getBoundingClientRect().right + n;
                                    ...
                                    for(var s = i / c(o), u = function(a) {
                                        ...
                                        if (!o || !o.length) return t.danTunnel[n][a + ""] = [
                                            e
        ...
        function(e, t, n) {
            ...
            e.exports = function(e) {
                "use strict";
                e = e || {};
                var t, a = "", o = (arguments[1], e.video), r = e.options, s = i.$escape, l = e.tran, c = e.icons, u = e.index, d = i.$each;
                e.$value, e.$index;
        ...
        function(e, t, n) {
            ...
            e.exports = function(e) {
                return c(e), e.baseURL && !s(e.url) && (e.url = l(e.baseURL, e.url)), e.headers = e.headers || {}, e.data = a(e.data, e.headers, e.transformRequest), e.headers = i.merge(e.headers.common || {}, e.headers[e.method] || {}, e.headers || {}), i.forEach([
                    "delete",
                    "get",
                    "head",
                    "post",
            ...
            e.exports = function(e) {
                ...
                return e ? (i.forEach(e.split("\n"), function(e) {
                    if (o = e.indexOf(":"), t = i.trim(e.substr(0, o)).toLowerCase(), n = i.trim(e.substr(o + 1)), t) {
                        ...
                        r[t] = "set-cookie" === t ? (r[t] ? r[t] : []).concat([
                            n
                        ]) : r[t] ? r[t] + ", " + n : n;
                    }
                }), r) : r;
            ...
            e.exports = function(e, t, n) {
                ...
                if (n) o = n(t);
                    ...
                    i.forEach(t, function(e, t) {
                        null !== e && void 0 !== e && (i.isArray(e) ? t += "[]" : e = [
                            e
        ...
        function(e, t, n) {
            ...
            }(), a = L(n(73)), o = L(n(1)), r = L(n(69)), s = L(n(48)), l = L(n(47)), c = L(n(2)), u = L(n(27)), d = L(n(26)), p = L(n(25)), h = L(n(24)), f = L(n(23)), y = L(n(22)), m = L(n(21)), v = L(n(20)), g = L(n(19)), b = L(n(17)), w = L(n(16)), k = L(n(15)), x = L(n(14)), S = L(n(13)), T = L(n(5));
            function L(e) {
                return e && e.__esModule ? e : {
                    default: e
                };
            ...
            var E = 0, M = [], _ = function() {
                ...
                return i(e, [
                    ...
                    },
                    {
                        key: "notice",
                        value: function(e) {
                            var t = this, n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 2e3, i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : .8;
